...
const memberDisplayMetadata: MemberDisplayMetadata[] = [
  ...
  { name: '唐 可可', group: 'liella', schoolYear: 3, sortOrder: 2, kind: 'single', units: ['cat-chu'] },
  { name: '嵐 千砂都', group: 'liella', schoolYear: 3, sortOrder: 3, kind: 'single', units: ['kaleidoscore'] },
  ...
  { name: '桜小路きな子', group: 'liella', schoolYear: 2, sortOrder: 6, kind: 'single', units: ['kaleidoscore'] },
  { name: '米女メイ', group: 'liella', schoolYear: 2, sortOrder: 7, kind: 'single', units: ['5yncri5e'] },
